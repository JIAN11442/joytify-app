...
type ManageSongCardActionsRequest = {
  song: RefactorSongResponse;
  isRated: boolean;
};

type ManageSongCardActionsResponse = {
  id: string;
...
export const getManageSongCardActionsContent = ({
  song,
  isRated,
}: ManageSongCardActionsRequest): ManageSongCardActionsResponse[] => {

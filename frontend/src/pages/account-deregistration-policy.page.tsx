...
import { accountDeregistrationPolicyContents } from "../contents/account-deregistration-policy.content";
import logo from "../images/logo-r.png";

const AccountDeregistrationPolicyPage = () => {
  const policyContents = accountDeregistrationPolicyContents;
  ...
  return (
    ...
    >
      ...
      <p
        ...
        `}
      >
        To protect your data privacy, your account and related data will be deleted according to the
        ...
        {policyContents.map((policy, index) => {
          ...
          return (
            <div key={id}>
              ...
              <hr className={`my-5 ${index !== policyContents.length - 1 ? "block" : "hidden"}`} />
            </div>
          );
        })}
